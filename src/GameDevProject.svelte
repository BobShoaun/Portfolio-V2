...
<main class="py-16">
	...
	<div  class="">
		<h1 data-aos="fade-left" class="font-bold text-2xl lg:text-3xl dark:text-gray-50">{name}</h1>
		<p  data-aos="fade-left" data-aos-delay="100" class="font-bold font-mono text-sm text-purple-700 mb-3 dark:text-purple-400">
			{collaborators}
		</p>
		<p data-aos="fade-left" data-aos-delay="200" class="text-md mb-3 text-gray-700 dark:text-gray-300">{description}</p>
		<p data-aos="fade-left" data-aos-delay="300" class="text-md font-semibold font-mono mb-4 dark:text-gray-50">
			{technologies.join(" // ")}
		</p>
		{#if github || website}
			<div data-aos="fade-left" data-aos-delay="400" class="float-right">
				{#if github}
