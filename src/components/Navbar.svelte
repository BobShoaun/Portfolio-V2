...
>
	<div class="logo font-semibold">
		<div data-aos="flip-up" data-aos-duration="700" class="bg-purple-400 w-4 h-4 mr-3 inline-block" />
	...
	<nav use:links class="hidden lg:flex links justify-between items-center space-x-12">
		<Router>
			...
			>
			<a href="/#web-development" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="700" noroute
				><p class="nav-text">Web dev</p></a
			>
			<!-- <a href="/#graphic-design" noroute><p class="text-gray-800 dark:text-gray-50 font-mono ">Design</p></a> -->
			<a href="/#game-development" data-aos="zoom-in" data-aos-delay="300" data-aos-duration="700" noroute
